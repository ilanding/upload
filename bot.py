...
HTML_REPOS = {
    "index": "ilanding/index",
    "index2": "ilanding/index2",
    "index3": "ilanding/index3",
}
...
def html_repo_keyboard():
    return InlineKeyboardMarkup(
        [
            [InlineKeyboardButton("1️⃣ ilanding/index", callback_data="select_repo:index")],
            [InlineKeyboardButton("2️⃣ ilanding/index2", callback_data="select_repo:index2")],
            [InlineKeyboardButton("3️⃣ ilanding/index3", callback_data="select_repo:index3")],
